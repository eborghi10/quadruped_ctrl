#ifndef _VISIONMPCLOCOMOTION_H
#define _VISIONMPCLOCOMOTION_H
...
private:
  ...
  void updateMPCIfNeeded(int* mpcTable, StateEstimatorContainer<float> &_stateEstimator);
